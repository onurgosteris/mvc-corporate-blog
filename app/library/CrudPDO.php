    ...
    public function update($table, $values, $options = [])
    {
        ...
        try {
            ...
            if (!empty($values[$options['pass']])) {
                $values[$options['pass']] = md5($values[$options['pass']]);
                // BENİ HATIRLA KISMINI İSTERSEN YORUM SATIRINI KALDIR.
...
//            exit;
    ...
    public function adminsLogin($admins_username, $admins_pass, $remember_me = null)
    {
        ...
        try {
            ...
            if ($stmt->rowCount() == 1) {
                ...
                /*
                 * ÇEREZLER İLE BENİ HATIRLA KISMI
    ...
    {
        // UNDEFİNED FUNCTİON HATASI VERİRSE PHP.İNİ DOSYASINDA
        // EXTENSİONLARDA mbstring in yorum satırını aç
    ...
    public function adminLogout()
    {
        ...
        // Beni hatırla kısmını yaparsan yorum satırını kaldır
        //setcookie("adminsLogin", json_encode($admins), strtotime("-30 day"), "/");
