    ...
    <div class="row pb-3">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card mb-2 p-3">
                <a href="http://<?php echo URL; ?>blogs/<?php echo $blogs['blogs_slug'] ?>">
                ...
                <div class="card-footer py-3 px-4">
                    <p class="m-0"><?php echo strip_tags(mb_strcut($blogs['blogs_content'],0,50)); ?>... <a
                                href="http://<?php echo URL; ?>blogs/<?php echo $blogs['blogs_slug'] ?>">Devamını oku</a></p>
                </div>
            </div>
        </div>
        <?php } ?>
        ...
        <div class="col-lg-12">
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center mb-4">
                    <li class="page-item ">
                        <a class="page-link" href="http://<?php echo URL; ?>kategori/<?php echo $data['kategori_slug'] ?>/sayfa/1" aria-label="Previous">
                    ...
                    <?php $sayfa_sayisi = ceil($data['blogs_toplam_icerik']/9);
                     for($i=1;$i<=$sayfa_sayisi;$i++){?>
                        <li class="page-item"><a class="page-link" href="http://<?php echo URL; ?>kategori/<?php echo $data['kategori_slug'] ?>/sayfa/<?php echo $i; ?>"><?php echo $i ?></a></li>
                    <?php } ?>
                    <li class="page-item">
                        <a class="page-link" href="http://<?php echo URL; ?>kategori/<?php echo $data['kategori_slug'] ?>/sayfa/<?php echo $sayfa_sayisi; ?>" aria-label="Next">
